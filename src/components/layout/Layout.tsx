...
import { FileText, Download, FileImage, FileSpreadsheet, ShieldCheck, Users, Settings as SettingsIcon, FileArchive } from 'lucide-react';
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { path: '/process-epp', label: 'Przetwarzanie EPP', icon: FileArchive },
